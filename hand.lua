...
function hand.initblood(snowman)
	...
	if snowman then system:setColors( 255, 255, 255, 128, 255,255, 255, 255 )
	else system:setColors( 255, 0, 0, 0, 255, 48, 0, 255 ) end
	...
	if snowman then system:setColors( 255, 255, 255, 0, 255,255, 255, 255 )
	else system:setColors( 255, 0, 0, 0, 255, 48, 0, 255 ) end
...
function hand.update(dt)
	...
	if (hand.currentSpeed < hand.maxSpeed) then
		hand.currentSpeed = hand.currentSpeed + dt*2
	end
	if (hand.fallSpeed < hand.maxFallSpeed) then
		hand.fallSpeed = hand.fallSpeed + dt*1.5
	end
